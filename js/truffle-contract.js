            ...
            Contract._static_methods = {
              ...
              new: function () {
                ...
                if (!this.unlinked_binary) {
                  throw new Error(
                    this._json.contract_name + " error: contract binary not set. Can't deploy new instance."
                  );
                }
                      ...
                      return new Promise(function (accept, reject) {
                        self.web3.eth.getCode(address, function (err, code) {
                          ...
                          if (!code || new BigNumber(code).eq(0)) {
                            return reject(
                              new Error(
                                "Cannot create instance of " + self.contract_name + "; no code at address " + address
                              )
                            );
                          }
                  ...
                  return self
                    ...
                    .then(function () {
                      ...
                      if (self._json.networks[self.network_id] == null) {
                        throw new Error(
                          self.contract_name + " has not been deployed to detected network (network/artifact mismatch)"
                        );
                      }
                      ...
                      if (!self.isDeployed()) {
                        throw new Error(
                          self.contract_name + " has not been deployed to detected network (" + self.network_id + ")"
                        );
                      }
            ...
            Contract._properties = {
              ...
              address: {
                get: function () {
                  ...
                  if (address == null) {
                    throw new Error(
                      "Cannot find deployed address: " + this.contract_name + " not deployed or address not set."
                    );
                  }
        ...
        (function (Buffer) {
          ...
          var coderAddress = {
            ...
            decode: function decodeAddress(data, offset) {
              ...
              if (data.length < offset + 32) {
                throw new Error(
                  "[ethjs-abi] while decoding address data, invalid address data, invalid byte length " + data.length
                );
              }
              return {
                consumed: 32,
